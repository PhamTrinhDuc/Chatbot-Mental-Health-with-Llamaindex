...
CUSTORM_AGENT_SYSTEM_TEMPLATE = """\
    ...
    Hãy nói chuyện với người dùng để thu thập thông tin cần thiết nhưng không hỏi quá sâu vào những vấn đề riêng tư. Và đến 1 thời điêm thích hợp thì bạn cần đưa ra lời khuyên cuối cùng cho người dùng.
